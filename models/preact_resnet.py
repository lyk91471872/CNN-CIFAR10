...
class PreActResNet18(BaseModel):
    ...
    def __init__(self, num_classes=10):
        ...
        self.layer1 = self._make_layer(PreActBlock, 64, 64, num_blocks=2, stride=1)
        self.layer2 = self._make_layer(PreActBlock, 64, 128, num_blocks=2, stride=2)
        self.layer3 = self._make_layer(PreActBlock, 128, 256, num_blocks=2, stride=2)
        self.layer4 = self._make_layer(PreActBlock, 256, 512, num_blocks=2, stride=2)
        ...
        self.fc = nn.Sequential(
            nn.Dropout(0.2),
            nn.Linear(512 * PreActBlock.expansion, num_classes)
        )
